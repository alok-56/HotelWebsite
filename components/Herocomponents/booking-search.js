...
export default function BookingSearch({ className }) {
  ...
  const handleSearch = () => {
    ...
    alert(
      `Search requested for ${destination || "Any destination"} from ${checkIn ? format(checkIn, "MMM dd, yyyy") : "Any date"} to ${checkOut ? format(checkOut, "MMM dd, yyyy") : "Any date"} with ${guests.rooms} room(s), ${guests.adults} adult(s), and ${guests.children} children`,
    )
  }
  ...
  return (
    <div
      className={cn(
        ...
        scrolled ? "top-0 px-4 md:px-8 lg:px-16" : "top-0 px-6 md:px-12 lg:px-24",
        className,
      )}
    >
      <div
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-5">
            ...
            >
              <PopoverTrigger asChild>
                <div className="flex cursor-pointer items-center p-4 hover:bg-gray-50">
                  <div className="flex-1 items-center justify-center flex-col">
                    <div className="text-sm font-medium text-gray-800">Destination</div>
                    <div className="flex items-center justify-center gap-2 pt-1">
                      <MapPin className="h-4 w-4 text-blue-900" />
                      <span className="text-sm text-gray-600">{destination || "Select Destination"}</span>
                    </div>
                  </div>
              ...
              <PopoverContent className="w-full p-0" align="start">
                <div className="p-4 flex justify-center items-center mx-auto flex-col">
                  <div className="mb-2 text-sm font-medium text-gray-800">Popular Destinations</div>
          ...
          <div className="relative border-b md:border-b-0 md:border-r">
            <Popover open={openPopover === "guests"} onOpenChange={(open) => setOpenPopover(open ? "guests" : null)}>
              <PopoverTrigger asChild>
                <div className="flex cursor-pointer items-center p-4 hover:bg-gray-50">
                  <div className="flex-1 flex-col justify-center">
                    <div className="text-sm font-medium text-gray-800">Rooms/Guests</div>
              ...
              <PopoverContent className="w-[260px] p-0" align="center">
                <div className="p-4">
                  <div className="mb-4 text-sm font-medium text-gray-800">Select Rooms & Guests</div>
                  ...
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <Button
                        ...
                        onClick={() => handleGuestChange("rooms", Math.max(1, guests.rooms - 1))}
                  ...
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <Button
                        ...
                        size="icon"
                        className="h-7 w-7 rounded-full p-0"
                        onClick={() => handleGuestChange("adults", Math.max(1, guests.adults - 1))}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <Button
                        ...
                        size="icon"
                        className="h-7 w-7 rounded-full p-0"
                        onClick={() => handleGuestChange("children", Math.max(0, guests.children - 1))}
          ...
          {/* Search Button */}
          <div className={cn("transition-all duration-300", scrolled ? "bg-blue-900" : "bg-blue-900")}>
            <button
              className="flex h-full w-full items-center justify-center gap-2 px-6 py-4 text-white transition-all hover:bg-blue-900"
              onClick={handleSearch}
            >
              <Search className={cn("transition-all", scrolled ? "h-4 w-4" : "h-5 w-5")} />
              <span className={cn("font-medium transition-all", scrolled ? "text-sm" : "text-base")}>
                Check Availability
              </span>
            </button>
          </div>
