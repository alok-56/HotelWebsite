  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        nav: "space-x-1 flex items-center gap-6 ",
        nav_button: cn(
        ...
        head_cell:
          "text-blue-500 rounded-md w-8  font-normal text-[0.8rem] dark:text-neutral-400",
        ...
        day_selected:
          "bg-blue-900 text-neutral-50 hover:bg-blue-900 hover:text-neutral-50 focus:bg-neutral-900 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today: "bg-blue-100 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
